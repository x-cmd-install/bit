...
[![x-cmd/install — bit Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/bit.svg?lang=zh)](https://x-cmd.com/install/bit)
...
合计: **6,078** 行代码（覆盖前 5 种语言、共 **30** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 6,072 | 5,764 | 479 | 24 |
| Sh | 6 | 1 | 4 | 2 |
| Markdown | 0 | 407 | 190 | 4 |
...
- **上游仓库**: <https://github.com/chriswalz/bit>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.1.2` (2021-07-05)
- **最近提交**: 2023-02-21
- **Release 含资产**: 10 个

## 流行度

- **Star**: 6,099 · **Fork**: 106 · **开放 issue**: 93 · **贡献者**: 18

## 累计统计

- **发布数**: 55 · **已合并 PR**: 21 · **开放 PR**: 2 · **已关闭 issue**: 63 · **开放 issue**: 30 · **提交数**: 322
...
| last720d | 2024-10-04 | 0 | 0 | 0 | 1 | 3 | 0 |
...
bit 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `bit` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/bit.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T03:54:32Z._
